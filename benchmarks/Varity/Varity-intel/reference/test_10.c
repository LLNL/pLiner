...
comp = (var_6 + fmod(exp(var_7 / -1.2544E-306 * var_8 / (-1.2961E-317 - +1.8071E305)), (-1.2481E-317 + fabs((var_9 - sinh(atan2(ceil(var_10 * fabs((-1.2694E305 * (-0.0 * (+1.5118E-312 - (var_11 / +1.4839E-307)))))), (var_12 / +1.0364E305))))))));
}
   printf("%.17g\n", comp);
