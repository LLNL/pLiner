...
comp_H = var_1_H / cosl(fabsl(-0.0 / +1.6123E-321 - log10l((+1.4208E305 / -1.5128E-321 / (var_2_H / -1.4080E305)))));
comp_H = var_3_H + (+1.5818E-316 * var_4_H + -1.1713E17 / +1.1396E-40);
if (comp_H >= (var_5_H * var_6_H)) {
  comp_H += fabsl((+1.4696E306 / atanl((+1.3548E-307 + coshl(-1.2865E-298)))));
}
if (comp_H == -1.3362E209 - var_7_H / var_8_H - var_9_H - var_10_H) {
  comp_H += (var_11_H - floorl(-1.8394E305));
}
   printf("%.17Lg\n", comp_H);
