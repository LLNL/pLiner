...
if (comp < (var_2 / -1.3223E291 / (+0.0 * var_3))) {
  for (int i=0; i < var_1; ++i) {
    comp = (var_4 * (-1.9589E-322 * (+1.6242E-306 - (+1.1704E306 - var_5))));
comp = log10((var_6 / var_7));
if (comp >= fabs(-1.3430E-307)) {
  double tmp_1 = -1.8244E-307;
comp = tmp_1 * var_8 * +1.3042E224 + (-1.9130E-322 * var_9 - +1.4440E305);
comp += var_10 * var_11;
}
if (comp == sin((-0.0 * var_12))) {
  comp = (var_13 / (var_14 - -1.4423E-158));
}
}
}
   printf("%.17g\n", comp);
