...
for (int i=0; i < var_3; ++i) {
  comp = (long double)var_12 / +0.0;
double tmp_1 = ldexpl(+0.0, 2);
long double comp_25_25_H = comp;
comp_25_25_H += (long double)tmp_1 + cosl((long double)var_13 - (long double)var_14 + +1.3058E-22);comp = comp_25_25_H;
