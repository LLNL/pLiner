...
if ((long double)comp > (long double)var_1 / ((long double)var_2 + atan2((long double)var_3 / floor(exp(-1.0614E-306)), sinh(+1.8209E-5)))) {
  comp = (-1.8797E-310 / ((long double)var_4 + -0.0));
}
   printf("%.17g\n", comp);
