...
if (comp <= +1.6266E-316 * var_2 - var_3 - var_4) {
  ...
  for (int i=0; i < var_1; ++i) {
    comp_18_29_H += ((long double)var_5 / +1.9927E-322 + (-1.4043E306 - (long double)var_6));
comp_18_29_H += (long double)var_7 + ((long double)var_8 * (long double)var_9 - (long double)var_10);
if (comp_18_29_H == -1.0052E305 / (long double)var_11 / expl((-1.1542E305 / (long double)var_12))) {
  comp_18_29_H = (long double)var_13 + acosl(((long double)var_14 + acosl(((long double)var_15 / +1.4681E305 + (long double)var_16))));
long double tmp_1_18_29_H = +1.5894E-307;
comp_18_29_H += tmp_1_18_29_H + ((long double)var_17 * (long double)var_18 / (-1.3407E-310 + (long double)var_19));
}
if (comp_18_29_H == cosl(-1.3511E-320 * cosl(-1.1104E306 / -1.0653E171))) {
  comp_18_29_H += +1.3631E306 + ((long double)var_20 - +1.7779E305 + +1.2478E-323);comp = comp_18_29_H;
