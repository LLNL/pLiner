...
if (comp <= asin(tanh(+1.6220E-94 / +1.5549E198 * atan2((var_3 + var_4 + +1.7243E-306), var_5 * atan2(asin(var_6 * floor(ldexp(+1.9699E235, 2))), +1.2464E-306))))) {
  for (int i=0; i < var_1; ++i) {
    long double comp_19_31_H = comp;
    for (int i=0; i < var_2; ++i) {
      long double tmp_1_19_31_H = -1.0991E306;
var_7[i] = -1.9672E-307 / -1.4747E305 + ((long double)var_9 - +1.6204E-152);
comp_19_31_H += (long double)var_7[i] / tmp_1_19_31_H / acosl(sqrtl((-0.0 - ((long double)var_10 / (-0.0 / (long double)var_11)))));
for (int i=0; i < var_8; ++i) {
  comp_19_31_H = (+1.6151E-322 * (+0.0 - +1.8874E305 - (long double)var_12));
long double tmp_2_19_31_H = +1.9356E-306 * cosl(-1.0212E-306);
comp_19_31_H = tmp_2_19_31_H * (long double)var_13 * ldexpl(-1.4135E-307 / -1.2124E305 / -1.6879E-312, 2);
}
if (comp_19_31_H <= (long double)var_14 / -1.2151E306) {
  comp_19_31_H = coshl((-1.1497E-312 * +1.1735E-323 - (long double)var_15 * (long double)var_16 / +1.8913E-321));comp = comp_19_31_H;
