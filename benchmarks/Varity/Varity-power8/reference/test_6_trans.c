...
long double comp_17_17_H = comp;
comp_17_17_H += expl(((long double)var_1 * (+1.3267E-306 * -1.2744E-319 / cosl(-1.2517E279 * fmodl((-0.0 + floor(+0.0)), expl((long double)var_2 / (long double)var_3))))));comp = comp_17_17_H;
