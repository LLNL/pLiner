...
comp_19_19_H += expl(+1.7529E305 + ((long double)var_2 / -0.0));comp = comp_19_19_H;

if ((long double)comp > tanhl(sinhl((+1.7152E-314 - (long double)var_3 / +0.0 + (long double)var_4 * (long double)var_5)))) {
